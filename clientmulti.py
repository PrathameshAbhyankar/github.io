        ...
        for classId, confidence,box in zip(classIds.flatten(),confs.flatten(),bbox):
            ...
            if className in objects:
                ...
                if (draw):
                    ...
                    dataString =  arrayAnimal[0] + "#" + arrayNode[0] + "#" + arrayLocation[0] + "#" +  arrayTime[0]
                    print(dataString)
...
while True:
    ...
    th.append(Thread(target=listener, args = (listenerArgs)).start())
    
    th.append(Thread(target=frameCapture, args = (frameArgs)).start())    
